...
manager = Manager()
uhgp_ids_per_genome = manager.list(udict.items()) # convert to list of tuples representation
del udict
...
if __name__ == '__main__':
    ...
    #def intersection_hits_curried(x):
    #    return(intersection_hits(x, uhgp_ids_per_genome))
